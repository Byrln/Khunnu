...
export function HunnuNavbar() {
  ...
  const logoElement = (
    <Link href="#hero" className="relative flex items-center space-x-2">
      <div className="relative w-10 h-10 flex items-center justify-center rounded-lg shadow-lg">
        <Image
          src="/Logo.jpg"
          alt="Hunnu Hotel"
          width={40}
  ...
  const bookNowButton = (
    <button
      ...
      className="px-4 py-2 text-sm border border-amber-800/50 bg-amber-800/20 text-amber-200 rounded-full hover:border-amber-700 hover:text-amber-100 hover:bg-amber-800/30 transition-all duration-200 w-full sm:w-auto whitespace-nowrap"
    >
      Book Now
    </button>
  );
  ...
  return (
    <header
      className={`fixed top-6 left-1/2 transform -translate-x-1/2 z-50
                       ...
                       rounded-full
                       border border-amber-800/20 bg-black/40
